...
dists = []
for key,val in crosses.items():
    if val == 2:
        a = eval (key)
        dists.append(manhattan_distance(a,[0, 0]))
print(min(dists))